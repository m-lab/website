...
* [Install Jekyll](https://jekyllrb.com/docs/installation/) using the instructions appropriate for your operating system.
...
* **File Names**
  ...
  * Concatenate multiple words in a filename with a hyphen
...
* **Liquid Variables**
  * For Liquid variables with more than one word, concatenate with an underscore character to differentiate from yml frontmatter variables
